...
void ModeDeadstop::update()
{
    ...
    // Brakes on full
    SRV_Channels::set_output_limit(SRV_Channel::k_rcin6, SRV_Channel::SRV_CHANNEL_LIMIT_MIN);

    // Ignition off
    SRV_Channels::set_output_limit(SRV_Channel::k_rcin7, SRV_Channel::SRV_CHANNEL_LIMIT_MAX);
